...
- GitHub Pages：新增 Deploy Static Pages workflow，构建 `/agent-workbench/` base 的静态版并通过 GitHub Actions 发布。
...
- Deploy Static Pages workflow 使用 `actions/configure-pages`、`actions/upload-pages-artifact` 和 `actions/deploy-pages` 完成发布。
